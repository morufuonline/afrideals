...
<?php 
if(isset($_SESSION["success"]) && !isset($_POST["remuneration"])){
...
<div style="font-size:16px; background:#eee; padding:10px; text-align:center;"><b>Category:</b> Job Vacancies</div>

<div class="col-md-3"></div>
<div class="col-md-6">

<h6>Add photos (1 for free) *<br><i style="font-weight:normal">(Format: .jpg, .gif, .png, .jpeg, Not more than 5MB)</i>
</h6>
...
<div class="det_count"<?php echo (isset($_SESSION["pictures"]) && count($_SESSION["pictures"]) >= 1)?" style='display:none;'":""; ?>>
...
<input type="hidden" name="purpose" value="job">
